...
CREATE TABLE IF NOT EXISTS `gpd` (
  ...
  `supervisor_name` varchar(50) COLLATE armscii8_bin NOT NULL,
  `shift` varchar(50) COLLATE armscii8_bin NOT NULL,
  `date` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `day` varchar(50) COLLATE armscii8_bin NOT NULL,
  `checktime` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `ball_mill_no` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `density` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  `viscosity` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  `residue` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  `silos_no` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  `stock` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  `wall_floor` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  `created_at` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  PRIMARY KEY (`gpd_id`)
) ENGINE=MyISAM DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Dumping data for table pk_tiles_db.gpd: 3 rows
...
CREATE TABLE IF NOT EXISTS `press` (
  ...
  `date` varchar(50) COLLATE armscii8_bin NOT NULL,
  `day` varchar(50) COLLATE armscii8_bin NOT NULL,
  `pressure_kn` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `cycle` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `pressure` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `thickness` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `corner_1` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `corner_2` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `corner_3` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `corner_4` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  `tile_center` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  `checking_time` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `created_at` varchar(50) COLLATE armscii8_bin DEFAULT NULL,
  PRIMARY KEY (`press_id`)
) ENGINE=MyISAM DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Dumping data for table pk_tiles_db.press: 3 rows
...
CREATE TABLE IF NOT EXISTS `slip_house` (
  ...
  `ball_mill_no` char(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `density` char(50) COLLATE armscii8_bin DEFAULT NULL,
  `viscosity` char(50) COLLATE armscii8_bin DEFAULT NULL,
  `residue` char(50) COLLATE armscii8_bin DEFAULT NULL,
  `silos_no` char(50) COLLATE armscii8_bin DEFAULT NULL,
  `stock` char(50) COLLATE armscii8_bin DEFAULT NULL,
  `wall_floor` char(50) COLLATE armscii8_bin DEFAULT NULL,
  `moisture` char(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
  `p_check_time` char(50) CHARACTER SET armscii8 COLLATE armscii8_bin DEFAULT NULL,
